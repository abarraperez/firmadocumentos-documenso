...
export class TelemetryClient {
  ...
  private async initialize(): Promise<void> {
    ...
    console.log(
      '[Telemetry] Telemetry is enabled. FirmaPrivada.bo collects anonymous usage data to help improve the product.',
    );
    console.log(
    ...
    console.log('[Telemetry] Learn more: https://firmaprivada.bo/docs/developers/self-hosting/telemetry');
