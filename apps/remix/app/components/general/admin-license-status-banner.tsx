        ...
        <div className="flex items-center">
          ...
          {match(licenseStatus)
            ...
            .with('UNAUTHORIZED', () =>
              license ? (
                <Trans>
                  Invalid License Type - Your FirmaPrivada.bo instance is using features that are not part of your license.
                </Trans>
              ) : (
                <Trans>Missing License - Your FirmaPrivada.bo instance is using features that require a license.</Trans>
              ),
            )
            .otherwise(() => null)}
        </div>
